...
- `JWT_EXPIRATION_MINUTES` - Время жизни JWT токена в минутах (по умолчанию: `10080` = 7 дней)
...
- **JWT токены**: Время жизни токена составляет 7 дней по умолчанию. Токен автоматически обновляется на клиенте, если он истекает в ближайшие 30 секунд.
