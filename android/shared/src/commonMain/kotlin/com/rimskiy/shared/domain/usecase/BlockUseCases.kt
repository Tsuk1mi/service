...
class CreateBlockUseCase(
    ...
    suspend operator fun invoke(blockedPlate: String, notifyOwner: Boolean = false, departureTime: String? = null, notificationMethod: String? = null): Result<Block> {
        return blockRepository.createBlock(blockedPlate, notifyOwner, departureTime, notificationMethod)
    }
}
