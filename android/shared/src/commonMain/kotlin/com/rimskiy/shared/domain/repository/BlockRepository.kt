...
class BlockRepository(
    ...
    override suspend fun createBlock(blockedPlate: String, notifyOwner: Boolean, departureTime: String?, notificationMethod: String?): Result<Block> {
        return try {
            ...
            val response = apiClient.createBlock(token, CreateBlockRequest(normalizedPlate, notifyOwner, departureTime, notificationMethod))
